...
#ifndef AZURE_SPHERE_GPTMASTER_H_
#define AZURE_SPHERE_GPTMASTER_H_
...
/// <summary>Returned when user tries to use timeout on free-running timer</summary>
#define ERROR_GPT_TIMEOUT_NOT_SUPPORTED (ERROR_SPECIFIC - 3)

/// <summary>Returned when user tries to use invalid timeout</summary>
#define ERROR_GPT_TIMEOUT_INVALID       (ERROR_SPECIFIC - 4)

/// <summary>Returned when user tries to set invalid speed</summary>
#define ERROR_GPT_SPEED_INVALID         (ERROR_SPECIFIC - 5)

/// <summary>Returned when user tries to pause a paused timer</summary>
#define ERROR_GPT_ALREADY_PAUSED        (ERROR_SPECIFIC - 6)

/// <summary>Returned when user tries to resume a timer not paused</summary>
#define ERROR_GPT_NOT_PAUSED            (ERROR_SPECIFIC - 7)

/// <summary>Opaque GPT Master handle.</summary>
typedef struct GPTMaster GPTMaster;
...
/// <summary>
/// <para>Acquires a handle to the timers context.</para>
/// </summary>
...
/// <returns>ERROR_NONE on success or an error code.</returns>
int32_t GPTMaster_GetMode(GPTMaster *handle, GPT_Mode *mode);
...
/// <summary>
/// <para>Pauses timer and saves state - recovered using GPTMaster_Resume.</para>
/// </summary>
/// <param name="handle">The GPT handle to the timer.</param>
/// <returns>ERROR_NONE on success or an error code.</returns>
...
/// <param name="handle">Which hardware timer to use.</param>
/// <param name="speedHz">Target speed to initialise the timer at (constructor
/// will find closest value supported by HW). If 0 is passed, then speed is
/// left at current value</param>
/// <returns>ERROR_NONE on success or an error code.</returns>
...
/// </summary>
/// <param name="handle">Which hardware timer to use.</param>
/// <param name="rangeValue">GPT_TestSpeeds object; to which will be written all
/// test speeds and the number of test speeds</param>
void GPTMaster_GetTestSpeeds(GPTMaster *handle, GPT_TestSpeeds *testSpeeds);


#endif // #ifndef AZURE_SPHERE_GPTMASTER_H_
