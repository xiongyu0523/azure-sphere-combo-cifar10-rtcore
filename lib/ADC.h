...
#ifndef AZURE_SPHERE_DRIVER_ADC_H_
#define AZURE_SPHERE_DRIVER_ADC_H_
...
/// <summary>Used to tell user when data has been transferred into buffer successfully.</summary>
