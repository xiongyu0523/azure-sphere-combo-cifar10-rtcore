...
#define GPIO_MAX_INDEX 6

#define GPIO_BLOCK_PIN_COUNT 4

#define GPIO_ADC_BLOCK_START 41
#define GPIO_ADC_BLOCK_INDEX 6
#define GPIO_ADC_BLOCK_PIN_COUNT 8
...
#define MT3620_GPIO_COUNT 6
static volatile mt3620_gpio_t * const mt3620_gpio[MT3620_GPIO_COUNT] = {           
    (volatile mt3620_gpio_t *)0x38010000,
    (volatile mt3620_gpio_t *)0x38020000,
    (volatile mt3620_gpio_t *)0x38030000,
    (volatile mt3620_gpio_t *)0x38040000,
    (volatile mt3620_gpio_t *)0x38050000,
    (volatile mt3620_gpio_t *)0x38060000,
};  

#define MT3620_PWM_COUNT 3
static volatile mt3620_pwm_t * const mt3620_pwm[MT3620_PWM_COUNT] = {
