...
// Enum for suggested SPI baud rates for master, obviously any integer can be used provided it
// remains within the hardware capabilities of the target device.
typedef enum {
    MT3620_SPI_BUS_SPEED_250K =   250000,
    MT3620_SPI_BUS_SPEED_500K =   500000,
    MT3620_SPI_BUS_SPEED_1M   =  1000000,
    MT3620_SPI_BUS_SPEED_2M   =  2000000,
    MT3620_SPI_BUS_SPEED_4M   =  4000000,
    MT3620_SPI_BUS_SPEED_6M   =  6000000,
    MT3620_SPI_BUS_SPEED_8M   =  8000000,
    MT3620_SPI_BUS_SPEED_10M  = 10000000,
    MT3620_SPI_BUS_SPEED_40M  = 40000000,
} mt3620_spi_bus_speed_e;

// Datasheet says this is 80MHz but it's actually 79.04MHz.
#define MT3620_SPI_HCLK (79040000)

// We see hardware errors when rs_clk_sel is set below this value.
#define MT3620_RS_CLK_SEL_MIN 4
